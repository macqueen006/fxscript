...
<head>
    ...
    <meta name="description"
        content="Providus Option is world's leading cryptocurrency online investment and trading platform that offers Bitcoin trading options, provides 24/7 customer support, high level of security, and stable deposits and withdrawals.">
    <meta name="keywords"
        content="Providus Option, Bitcoin Investment, Bitcoin Trading Platform, Binary Trading Platform, Digital Options Trading, BTC">
    ...
    <style>
        ...
        .goog-te-menu2 {
            font-family: 'Montserrat', sans-serif !important;
            font-size: 14pt !important;
            border: 1px solid #a40fff !important;
...
<body data-spy="scroll">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="contact-info">
                            <a href="mailto:contact@f1globalforex.com"> <i class="fa fa-envelope email"
                                    aria-hidden="true"></i> contact@providusoption.com</a>
                            ...
                            <a href="#"> <i class="fa fa-language" aria-hidden="true" style="margin-left: 2px;"></i>
                                ...
                                <script type="text/javascript"
                                    src="../translate.google.com/translate_a/elementa0d8.html?cb=googleTranslateElementInit">
                                </script>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="login-admin login-admin1">
                        ...
                        <div class="login-form">
                            ...
                            <center>
                                <br><br>
                                <p>Verified successfully? <a href="login.php" class="theme_button color1">Login Now</a>
                                </p>
                            </center>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="maintenanceModal" tabindex="-1" role="dialog"
        style="transition: top 0.5s ease 0s; background: #0a586573;">
            ...
            <div class="modal-content">
                <div class="card card-signup card-plain" style="padding: 19px 13px 0px; margin-bottom: 4px;">
                    <div class="modal-header"
                        style="display: flex; align-items: flex-start;justify-content: space-between;padding: 0px 24px 17px 24px;">
                        <h2 class="modal-title card-title"
                            style="text-align: center;width: 100%;margin-top: .625rem;font-size: 2em;">UPDATE!</h2>
                        <button type="button" class="close" data-dismiss="modal" id="closepop" aria-label="Close"
                        ...
                        <div class="features-2" style="padding: 0px 0;">
                            <div class="row">
                                <div class="col-md-12 ml-auto mr-auto text-center"
                                    style="margin-right: auto!important;margin-left: auto!important;float: initial;">
                                    <img class="card-img-top" src="assets/images/maintenance.svg" alt="Card image cap"
                                        style="margin: -8px 0px;width: 40%;margin-bottom: 10px;">
                                    <h4 class="title" style="margin: 15px 0px 15px;">We Are Upgrading!</h4>
                                    <p class="description"
                                        style="font-family: Roboto,Helvetica,Arial,sans-serif; font-weight: 300; line-height: 1.5em;font-size: 15px;">
                                        Whilst our preference is to achieve the upgrade without causing any disruption
                                        to your usual investment arrangements, we would like to inform you that
                                        unfortunately, during this upgrade period, all of our investments services will
                                        be suspended for 24 hours for the purpose of implementing the system upgrade.
                                        <br><br>
                                        After the conversion period, we will be able to provide our normal investment
                                        services as usual. Please be assured that we have taken and will continue to
                                        take steps to make sure the transition will be fully completed with minimum
                                        disruption.
                                        <br><br>
                                        Thank You!
                                    </p>
                            ...
                            <div class="modal-footer" style="padding: 8px 24px;">
                                ...
                                <a href="mailto:contact@f1globalforex.com" class="btn btn-info btn-sm btn-link">Email
                                    Support</a>
                                <button type="button" class="btn btn-danger btn-link btn-sm" data-dismiss="modal"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/5e192b003b4e6.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/5e192b1eeaf5f.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/5e192b6c865f4.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/5e192b965a362.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/5e192c0ed797d.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/magento_skrill_1.jpg"
                                                    alt="client"></a></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="our-client wow rotateIn" data-wow-duration="2s"><a href="#"><img
                                                    class="img-responsive" src="assets/images/1508740692h7.png"
                                                    alt="client"></a></div>
                                    </div>
                                </div>
                                <!-- Add Arrows -->
    ...
    <script type="text/javascript">
        (function (w, d, s, u) {
            ...
            var h = d.getElementsByTagName(s)[0],
                j = d.createElement(s);
            j.async = true;
            j.src = '../livechat.oaksideinvestments.com/js/jaklcpchat.js';
